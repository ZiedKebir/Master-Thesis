    ...
    for l in RL:
        ...
        for std in std_l:
            ...
            for pos in Pos:
                d["pos"] = pos
                print("pos= ", pos)
                NDCG_mean_random = Measuring_quality(Ranking_change_mean_random, "NDCG", d)
                # print("NDCG_mean_random",NDCG_mean_random)
                NDCG_mean_Asc = Measuring_quality(Ranking_change_mean_Asc, "NDCG", d)
                # print("NDCG_mean_Asc", NDCG_mean_Asc)
                NDCG_mean_Desc = Measuring_quality(Ranking_change_mean_Desc, "NDCG", d)
                # print("NDCG_mean_Desc",NDCG_mean_Desc)

                #print("Random: ", NDCG_mean_random)
                #print("ASC: ", NDCG_mean_Asc)
                #print("DESC: ", NDCG_mean_Desc)
                plt.plot(range(int(d["mean_lower_limit"]),int(d["mean_upper_limit"])), NDCG_mean_random, color="red", label="Random Rank Allocation")
                plt.plot(range(int(d["mean_lower_limit"]),int(d["mean_upper_limit"])), NDCG_mean_Asc, color="blue", label="Ascending Rank Allocation")
                plt.plot(range(int(d["mean_lower_limit"]),int(d["mean_upper_limit"])), NDCG_mean_Desc, color="green", label="Descending Rank Allocation")
                plt.xlabel("Mean")
                plt.ylabel("NDCG")
                #plt.xlim(80,300)
                plt.legend()
                plt.title("Normal:std=" + str(std) + " Pos="  +str(d["pos"]) + " Rl= " +str(d["Ranking_length"]))
                plt.savefig("C:/Users/ziedk/PycharmProjects/Master Thesis/Plots/Normal Distribution/NDCG/New vary mean std="+ str(std) + " pos= "  +str(d["pos"]) + " R length= " +str(d["Ranking_length"])+"bt =" + d["Type_position_bias"]+ "xlim" + ".png")
                plt.show()
    ...
    for l in RL:
        ...
        for mean in mean_l:
            ...
            for pos in Pos:
                ...
                NDCG_mean_Desc = Measuring_quality(Ranking_change_mean_Desc, "NDCG", d)
                # print("NDCG_mean_Desc",NDCG_mean_Desc)
                plt.plot(range(int(d["std1_lower_limit"]),int(d["std1_upper_limit"])), NDCG_mean_random, color="red", label="Random Rank Allocation")
                plt.plot(range(int(d["std1_lower_limit"]),int(d["std1_upper_limit"])), NDCG_mean_Asc, color="blue", label="Ascending Rank Allocation")
                plt.plot(range(int(d["std1_lower_limit"]),int(d["std1_upper_limit"])), NDCG_mean_Desc, color="green", label="Descending Rank Allocation")
                ...
                plt.savefig("C:/Users/ziedk/PycharmProjects/Master Thesis/Plots/Normal Distribution/NDCG/New vary std mean="+ str(mean) + " pos= "  +str(d["pos"]) + " R length= " +str(d["Ranking_length"])+"bt =" + d["Type_position_bias"]+".png")
                plt.show()
...
def change_mean_unif(interval_size, Pos=[0.5], Rl=[100]):
    ...
    for rank_length in Rl:
        ...
        for pos in Pos:
            ...
            NDCG_interval_random = Measuring_quality(Ranking_change_interval_random, "NDCG", d)
            # print("NDCG_mean_random",NDCG_mean_random)
            NDCG_interval_Asc = Measuring_quality(Ranking_change_interval_Asc, "NDCG", d)
            # print("NDCG_mean_Asc", NDCG_mean_Asc)
            NDCG_interval_Desc = Measuring_quality(Ranking_change_interval_Desc, "NDCG", d)
            # print("NDCG_mean_Desc",NDCG_mean_Desc)


            plt.plot([round((i[0] + i[1]) / 2) for i in [[i, i + interval_size] for i in range(a, b, range_gap)]], NDCG_interval_Asc,color="blue", label="Ascending Rank Allocation")
            plt.plot([round((i[0] + i[1]) / 2) for i in [[i, i + interval_size] for i in range(a, b, range_gap)]], NDCG_interval_Desc,color="green", label="Descending Rank Allocation")
            plt.plot([round((i[0] + i[1]) /2) for i in [[i, i + interval_size] for i in range(a, b, range_gap)]], NDCG_interval_random,color="Red", label="Random Rank Allocation")
            plt.legend()

            # sc = plt.scatter([str(i) for i in data_asc["range"]], data_asc["Pos"], c= data_asc["NDCG"], s=point_size)
            plt.title("Uniform:"+str_range + " Rl=" + str(rank_length)+" Pos="+str(pos))
            plt.xlabel("Mean", fontsize=10)
            plt.ylabel("NDCG", fontsize=10)
            ...
            plt.savefig(
                "C:/Users/ziedk/PycharmProjects/Master Thesis/Plots/Uniform Distribution/NDCG/New NDCG line " + str_range + "bt " +
...
def change_std_unif(Rl=[100],Pos=[0.5]):
        ...
        for rank_length in Rl:
            ...
            for pos in Pos:
                ...
                ## ASC ###
                # point_size = np.array(data_asc["NDCG"]) * 350
                plt.plot([math.sqrt(pow((2*i+b-a),2)/12)for i in range(0,int(a/range_gap)+1,range_gap)],
                         NDCG_interval_Asc, color="blue", label="Ascending Rank Allocation")
                plt.plot([math.sqrt(pow((2*i+b-a),2)/12)for i in range(0,int(a/range_gap)+1,range_gap)],
                         NDCG_interval_Desc, color="green", label="Descending Rank Allocation")
                plt.plot([math.sqrt(pow((2*i+b-a),2)/12)for i in range(0,int(a/range_gap)+1,range_gap)],
                         NDCG_interval_random, color="Red", label="Random Rank Allocation")
                #plt.axhline(y=0.5, color='black', linestyle='-')
                plt.legend()
                # sc = plt.scatter([str(i) for i in data_asc["range"]], data_asc["Pos"], c= data_asc["NDCG"], s=point_size)
                plt.title("Uniform:" + str_range + " Rl=" + str(rank_length) + " Pos=" + str(pos))
                ...
                plt.ylabel("NDCG", fontsize=10)
                plt.savefig("C:/Users/ziedk/PycharmProjects/Master Thesis/Plots/Uniform Distribution/NDCG/New NDCG var " + str_range + "bt " +d["Type_position_bias"] + " pos= " + str(d["pos"]) + " RL= " + str(rank_length) + ".png")
                plt.show()
    ...
    for l in RL:
        ...
        for scale in Scale:
            ...
            for pos in Pos:
                ...
                plt.plot(range(int(d["shape_lower_limit"]), int(d["shape_upper_limit"])), NDCG_mean_random, color="red",
                         label="Random Rank Allocation")
                plt.plot(range(int(d["shape_lower_limit"]), int(d["shape_upper_limit"])), NDCG_mean_Asc, color="blue",
                         label="Ascending Rank Allocation")
                plt.plot(range(int(d["shape_lower_limit"]), int(d["shape_upper_limit"])), NDCG_mean_Desc, color="green",
                ...
                plt.title("Gamma:Scale=" + str(scale) + " Pos=" + str(d["pos"]) + " Rl=" + str(
                    d["Ranking_length"]))
                plt.savefig(
                    "C:/Users/ziedk/PycharmProjects/Master Thesis/Plots/Gamma Distribution/NDCG/New Mean x axis NDCG Gamma dist scale=" + str(
    ...
    for l in RL:
        ...
        for shape in Shape:
            ...
            for pos in Pos:
                ...
                plt.plot([np.sqrt(shape*i*i) for i in range(int(d["shape_lower_limit"]), int(d["shape_upper_limit"]))], NDCG_mean_random, color="red",
                         label="Random Rank Allocation")
                plt.plot([np.sqrt(shape*i*i) for i in range(int(d["shape_lower_limit"]), int(d["shape_upper_limit"]))], NDCG_mean_Asc, color="blue",
                         label="Ascending Rank Allocation")
                plt.plot([np.sqrt(shape*i*i) for i in range(int(d["shape_lower_limit"]), int(d["shape_upper_limit"]))], NDCG_mean_Desc, color="green",
                         label="Descending Rank Allocation")
                plt.xlabel("Std")
                plt.ylabel("NDCG")
                plt.legend()
                plt.title(
                    "Gamma:Shape=" + str(shape) + " Pos=" + str(d["pos"]) + " Rl=" + str(
                        d["Ranking_length"]))
                plt.savefig("C:/Users/ziedk/PycharmProjects/Master Thesis/Plots/Gamma Distribution/NDCG/New NDCG Gamma Vary Scale shape=" + str(shape) + " pos= " + str(d["pos"]) + " R length= " + str(d["Ranking_length"]) + ".png")
                plt.show()
    ...
    for l in RL:
        ...
        for alpha in Alpha:
            ...
            for pos in Pos:
                ...
                plt.plot([alpha/(i+alpha) for i in r], NDCG_mean_random, color="red",
                         label="Random Rank Allocation")
                plt.plot([alpha/(i+alpha) for i in r], NDCG_mean_Asc, color="blue",
                         label="Ascending Rank Allocation")
                plt.plot([alpha/(i+alpha) for i in r], NDCG_mean_Desc, color="green",
                         label="Descending Rank Allocation")
                #plt.axhline(y=0.5, color='black', linestyle='-')
                ...
                plt.title(
                    "Beta:Alpha=" + str(alpha) + " Pos=" + str(d["pos"]) + " Rl=" + str(
                        d["Ranking_length"]))
                plt.savefig(
                    "C:/Users/ziedk/PycharmProjects/Master Thesis/Plots/Beta Distribution/NDCG/New NDCG Beta Vary beta_mean alpha=" + str(
    ...
    for l in RL:
        ...
        for alpha in Alpha:
            ...
            for pos in Pos:
                ...
                plt.plot([std_beta_dist(alpha,i) for i in r], NDCG_mean_random, color="red",
                         label="Random Rank Allocation")
                plt.plot([std_beta_dist (alpha,i) for i in r], NDCG_mean_Asc, color="blue",
                         label="Ascending Rank Allocation")
                plt.plot([std_beta_dist (alpha,i) for i in r], NDCG_mean_Desc, color="green",
                         label="Descending Rank Allocation")
                #plt.axhline(y=0.5, color='black', linestyle='-')
                plt.xlabel("Std_beta")
                plt.ylabel("NDCG")
                ...
                plt.title(
                    "Beta:Alpha=" + str(alpha) + " Pos=" + str(d["pos"]) + " Rl=" + str(
                        d["Ranking_length"]))
                plt.savefig(
                    "C:/Users/ziedk/PycharmProjects/Master Thesis/Plots/Beta Distribution/NDCG/New NDCG Beta Vary beta alpha=" + str(
                        alpha) + " pos= " + str(d["pos"]) + " R length= " + str(d["Ranking_length"]) + ".png")
                plt.show()
    ...
    for l in RL:
        ...
        for beta in Beta:
            ...
            for pos in Pos:
                ...
                plt.plot([i/(i+beta)for i in r], NDCG_mean_random, color="red",
                         label="Random Rank Allocation")
                plt.plot([i/(i+beta)for i in r], NDCG_mean_Asc, color="blue",
                         label="Ascending Rank Allocation")
                plt.plot([i/(i+beta)for i in r], NDCG_mean_Desc, color="green",
                         label="Descending Rank Allocation")
                #plt.axhline(y=0.5, color='black', linestyle='-')
                ...
                plt.title(
                    "Beta:Beta=" + str(beta) + " Pos=" + str(d["pos"]) + " Rl= " + str(
                        d["Ranking_length"]))
                plt.savefig(
                    "C:/Users/ziedk/PycharmProjects/Master Thesis/Plots/Beta Distribution/NDCG/New NDCG Beta dist Vary alpha_mean beta=" + str(
    ...
    for l in RL:
        ...
        for beta in Beta:
            ...
            for pos in Pos:
                ...
                plt.plot([std_beta_dist(i,beta)for i in r], NDCG_mean_random, color="red",
                         label="Random Rank Allocation")
                plt.plot([std_beta_dist(i,beta)for i in r], NDCG_mean_Asc, color="blue",
                         label="Ascending Rank Allocation")
                plt.plot([std_beta_dist(i,beta)for i in r], NDCG_mean_Desc, color="green",
                         label="Descending Rank Allocation")
                #plt.axhline(y=0.5, color='black', linestyle='-')
                ...
                plt.title(
                    "Beta:Beta=" + str(beta) + " Pos=" + str(d["pos"]) + " Rl= " + str(
                        d["Ranking_length"]))
                plt.savefig(
                    "C:/Users/ziedk/PycharmProjects/Master Thesis/Plots/Beta Distribution/NDCG/New NDCG Beta dist Vary alpha_std beta=" + str(
                        beta) + " pos= " + str(d["pos"]) + " R length= " + str(d["Ranking_length"]) + ".png")
                plt.show()
    ...
    for l in RL:
        ...
        for prop_dist in Prop_dist:
            ...
            for mean_diff in Mean_diff:
                ...
                #print(NDCG_change_mean_Asc)
                for pos in Pos:
                    d["pos"] = pos
                    print("pos= ", pos)
                    NDCG_change_mean_random = Measuring_quality(Ranking_change_mean_random, "NDCG", d)
                    # print("NDCG_mean_random",NDCG_mean_random)
                    NDCG_change_mean_Asc = Measuring_quality(Ranking_change_mean_Asc, "NDCG", d)
                    # print("NDCG_mean_Asc", NDCG_mean_Asc)
                    NDCG_change_mean_Desc = Measuring_quality(Ranking_change_mean_Desc, "NDCG", d)
                    # print("NDCG_mean_Desc",NDCG_mean_Desc)
                    #print(NDCG_change_mean_random)

                    plt.plot([i*prop_dist+(1-prop_dist)*(i+mean_diff) for i in range(int(d["mean_lower_limit"]), int(d["mean_upper_limit"]))], NDCG_change_mean_random, color="red",
                             label="Random Rank Allocation")
                    plt.plot([i*prop_dist+(1-prop_dist)*(i+mean_diff) for i in range(int(d["mean_lower_limit"]), int(d["mean_upper_limit"]))], NDCG_change_mean_Asc, color="blue",
                             label="Ascending Rank Allocation")
                    plt.plot([i*prop_dist+(1-prop_dist)*(i+mean_diff) for i in range(int(d["mean_lower_limit"]), int(d["mean_upper_limit"]))], NDCG_change_mean_Desc, color="green",
                             label="Descending Rank Allocation")
                    plt.xlabel("Mean")
                    plt.ylabel("NDCG")
                    plt.legend()
                    plt.title("Bimod:"+"P= "+str(d["p"])+" Mean_diff="+ str(mean_diff) + " Std1=" + str(std1)+ " Std2="+ str(std2) + " Pos=" + str(d["pos"]) + " Rl=" + str(d["Ranking_length"]))
                    plt.savefig("C:/Users/ziedk/PycharmProjects/Master Thesis/Plots/Bimodal Distribution/NDCG/"+"New NDCG BI"+"prop_dist="+str(d["p"])+"mean_range="+str([d["mean_lower_limit"],d["mean_upper_limit"]])+"mean_diff="+ str(mean_diff) + "std1=" + str(std1)+ "std2="+ str(std2) + " pos=" + str(d["pos"]) + " RL= " + str(d["Ranking_length"])+".png")
                    plt.show()
        ...
        for prop_dist in P:
            ...
            for std_diff in std_diff:
                ...
                for pos in Pos:
                    ...
                    plt.plot([std_bim(i,std_diff,prop_dist) for i in range(int(d["std1_lower_limit"]), int(d["std1_upper_limit"]))], NDCG_change_mean_random, color="red",
                             label="Random Rank Allocation")
                    plt.plot([std_bim(i,std_diff,prop_dist) for i in range(int(d["std1_lower_limit"]), int(d["std1_upper_limit"]))], NDCG_change_mean_Asc, color="blue",
                             label="Ascending Rank Allocation")
                    plt.plot([std_bim(i,std_diff,prop_dist) for i in range(int(d["std1_lower_limit"]), int(d["std1_upper_limit"]))], NDCG_change_mean_Desc, color="green",
                             label="Descending Rank Allocation")
                    plt.xlabel("Std")
                    plt.ylabel("NDCG")
                    plt.legend()
                    plt.title("Bimod:"+"P="+str(d["p"])+" Std_diff="+ str(std_diff) + " Mean1=" + str(mean1)+ " Mean2="+ str(mean2) + " Pos=" + str(d["pos"]) + " Rl=" + str(d["Ranking_length"]))
                    plt.savefig("C:/Users/ziedk/PycharmProjects/Master Thesis/Plots/Bimodal Distribution/NDCG/"+"New NDCG BI"+"prop_dist="+str(d["p"])+"std_range="+str([d["std1_lower_limit"],d["std1_upper_limit"]])+"std_diff="+ str(std_diff) + "mean1=" + str(mean1)+ "mean2="+ str(mean2) + " pos=" + str(d["pos"]) + " RL= " + str(d["Ranking_length"])+".png")
                    plt.show()
