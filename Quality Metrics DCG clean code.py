    ...
    for l in RL:
        ...
        for std in std_l:
            ...
            for pos in Pos:
                d["pos"] = pos
                print("pos= ", pos)
                DCG_mean_random = Measuring_quality(Ranking_change_mean_random, "DCG", d)
                # print("DCG_mean_random",DCG_mean_random)
                DCG_mean_Asc = Measuring_quality(Ranking_change_mean_Asc, "DCG", d)
                # print("DCG_mean_Asc", DCG_mean_Asc)
                DCG_mean_Desc = Measuring_quality(Ranking_change_mean_Desc, "DCG", d)
                # print("DCG_mean_Desc",DCG_mean_Desc)

                #print("Random: ", DCG_mean_random)
                #print("ASC: ", DCG_mean_Asc)
                #print("DESC: ", DCG_mean_Desc)
                plt.plot(range(int(d["mean_lower_limit"]),int(d["mean_upper_limit"])), DCG_mean_random, color="red", label="Random Rank Allocation")
                plt.plot(range(int(d["mean_lower_limit"]),int(d["mean_upper_limit"])), DCG_mean_Asc, color="blue", label="Ascending Rank Allocation")
                plt.plot(range(int(d["mean_lower_limit"]),int(d["mean_upper_limit"])), DCG_mean_Desc, color="green", label="Descending Rank Allocation")
                plt.xlabel("Mean")
                plt.ylabel("DCG")
                #plt.xlim(80,300)
                plt.legend()
                plt.title("Normal:std=" + str(std) + " Pos="  +str(d["pos"]) + " Rl= " +str(d["Ranking_length"]))
                plt.savefig("C:/Users/ziedk/PycharmProjects/Master Thesis/Plots/Normal Distribution/DCG/New vary mean std="+ str(std) + " pos= "  +str(d["pos"]) + " R length= " +str(d["Ranking_length"])+"bt =" + d["Type_position_bias"]+ "xlim" + ".png")
                plt.show()
    ...
    for l in RL:
        ...
        for mean in mean_l:
            ...
            for pos in Pos:
                ...
                DCG_mean_Desc = Measuring_quality(Ranking_change_mean_Desc, "DCG", d)
                # print("DCG_mean_Desc",DCG_mean_Desc)
                plt.plot(range(int(d["std1_lower_limit"]),int(d["std1_upper_limit"])), DCG_mean_random, color="red", label="Random Rank Allocation")
                plt.plot(range(int(d["std1_lower_limit"]),int(d["std1_upper_limit"])), DCG_mean_Asc, color="blue", label="Ascending Rank Allocation")
                plt.plot(range(int(d["std1_lower_limit"]),int(d["std1_upper_limit"])), DCG_mean_Desc, color="green", label="Descending Rank Allocation")
                ...
                plt.savefig("C:/Users/ziedk/PycharmProjects/Master Thesis/Plots/Normal Distribution/DCG/New vary std mean="+ str(mean) + " pos= "  +str(d["pos"]) + " R length= " +str(d["Ranking_length"])+"bt =" + d["Type_position_bias"]+".png")
                plt.show()
...
def change_mean_unif(interval_size, Pos=[0.5], Rl=[100]):
    ...
    for rank_length in Rl:
        ...
        for pos in Pos:
            ...
            DCG_interval_random = Measuring_quality(Ranking_change_interval_random, "DCG", d)
            # print("DCG_mean_random",DCG_mean_random)
            DCG_interval_Asc = Measuring_quality(Ranking_change_interval_Asc, "DCG", d)
            # print("DCG_mean_Asc", DCG_mean_Asc)
            DCG_interval_Desc = Measuring_quality(Ranking_change_interval_Desc, "DCG", d)
            # print("DCG_mean_Desc",DCG_mean_Desc)


            plt.plot([round((i[0] + i[1]) / 2) for i in [[i, i + interval_size] for i in range(a, b, range_gap)]], DCG_interval_Asc,color="blue", label="Ascending Rank Allocation")
            plt.plot([round((i[0] + i[1]) / 2) for i in [[i, i + interval_size] for i in range(a, b, range_gap)]], DCG_interval_Desc,color="green", label="Descending Rank Allocation")
            plt.plot([round((i[0] + i[1]) /2) for i in [[i, i + interval_size] for i in range(a, b, range_gap)]], DCG_interval_random,color="Red", label="Random Rank Allocation")
            plt.legend()

            # sc = plt.scatter([str(i) for i in data_asc["range"]], data_asc["Pos"], c= data_asc["DCG"], s=point_size)
            plt.title("Uniform:"+str_range + " Rl=" + str(rank_length)+" Pos="+str(pos))
            plt.xlabel("Mean", fontsize=10)
            plt.ylabel("DCG", fontsize=10)
            ...
            plt.savefig(
                "C:/Users/ziedk/PycharmProjects/Master Thesis/Plots/Uniform Distribution/DCG/New DCG line " + str_range + "bt " +
...
def change_std_unif(Rl=[100],Pos=[0.5]):
        ...
        for rank_length in Rl:
            ...
            for pos in Pos:
                ...
                ## ASC ###
                # point_size = np.array(data_asc["DCG"]) * 350
                plt.plot([math.sqrt(pow((2*i+b-a),2)/12)for i in range(0,int(a/range_gap)+1,range_gap)],
                         DCG_interval_Asc, color="blue", label="Ascending Rank Allocation")
                plt.plot([math.sqrt(pow((2*i+b-a),2)/12)for i in range(0,int(a/range_gap)+1,range_gap)],
                         DCG_interval_Desc, color="green", label="Descending Rank Allocation")
                plt.plot([math.sqrt(pow((2*i+b-a),2)/12)for i in range(0,int(a/range_gap)+1,range_gap)],
                         DCG_interval_random, color="Red", label="Random Rank Allocation")
                #plt.axhline(y=0.5, color='black', linestyle='-')
                plt.legend()
                # sc = plt.scatter([str(i) for i in data_asc["range"]], data_asc["Pos"], c= data_asc["DCG"], s=point_size)
                plt.title("Uniform:" + str_range + " Rl=" + str(rank_length) + " Pos=" + str(pos))
                ...
                plt.ylabel("DCG", fontsize=10)
                plt.savefig("C:/Users/ziedk/PycharmProjects/Master Thesis/Plots/Uniform Distribution/DCG/New DCG var " + str_range + "bt " +d["Type_position_bias"] + " pos= " + str(d["pos"]) + " RL= " + str(rank_length) + ".png")
                plt.show()
    ...
    for l in RL:
        ...
        for scale in Scale:
            ...
            for pos in Pos:
                ...
                plt.plot(range(int(d["shape_lower_limit"]), int(d["shape_upper_limit"])), DCG_mean_random, color="red",
                         label="Random Rank Allocation")
                plt.plot(range(int(d["shape_lower_limit"]), int(d["shape_upper_limit"])), DCG_mean_Asc, color="blue",
                         label="Ascending Rank Allocation")
                plt.plot(range(int(d["shape_lower_limit"]), int(d["shape_upper_limit"])), DCG_mean_Desc, color="green",
                ...
                plt.title("Gamma:Scale=" + str(scale) + " Pos=" + str(d["pos"]) + " Rl=" + str(
                    d["Ranking_length"]))
                plt.savefig(
                    "C:/Users/ziedk/PycharmProjects/Master Thesis/Plots/Gamma Distribution/DCG/New Mean x axis DCG Gamma dist scale=" + str(
    ...
    for l in RL:
        ...
        for shape in Shape:
            ...
            for pos in Pos:
                ...
                plt.plot([np.sqrt(shape*i*i) for i in range(int(d["shape_lower_limit"]), int(d["shape_upper_limit"]))], DCG_mean_random, color="red",
                         label="Random Rank Allocation")
                plt.plot([np.sqrt(shape*i*i) for i in range(int(d["shape_lower_limit"]), int(d["shape_upper_limit"]))], DCG_mean_Asc, color="blue",
                         label="Ascending Rank Allocation")
                plt.plot([np.sqrt(shape*i*i) for i in range(int(d["shape_lower_limit"]), int(d["shape_upper_limit"]))], DCG_mean_Desc, color="green",
                         label="Descending Rank Allocation")
                plt.xlabel("Std")
                plt.ylabel("DCG")
                plt.legend()
                plt.title(
                    "Gamma:Shape=" + str(shape) + " Pos=" + str(d["pos"]) + " Rl=" + str(
                        d["Ranking_length"]))
                plt.savefig("C:/Users/ziedk/PycharmProjects/Master Thesis/Plots/Gamma Distribution/DCG/New DCG Gamma Vary Scale shape=" + str(shape) + " pos= " + str(d["pos"]) + " R length= " + str(d["Ranking_length"]) + ".png")
                plt.show()
    ...
    for l in RL:
        ...
        for alpha in Alpha:
            ...
            for pos in Pos:
                ...
                plt.plot([alpha/(i+alpha) for i in r], DCG_mean_random, color="red",
                         label="Random Rank Allocation")
                plt.plot([alpha/(i+alpha) for i in r], DCG_mean_Asc, color="blue",
                         label="Ascending Rank Allocation")
                plt.plot([alpha/(i+alpha) for i in r], DCG_mean_Desc, color="green",
                         label="Descending Rank Allocation")
                #plt.axhline(y=0.5, color='black', linestyle='-')
                ...
                plt.title(
                    "Beta:Alpha=" + str(alpha) + " Pos=" + str(d["pos"]) + " Rl=" + str(
                        d["Ranking_length"]))
                plt.savefig(
                    "C:/Users/ziedk/PycharmProjects/Master Thesis/Plots/Beta Distribution/DCG/New DCG Beta Vary beta_mean alpha=" + str(
    ...
    for l in RL:
        ...
        for alpha in Alpha:
            ...
            for pos in Pos:
                ...
                plt.plot([std_beta_dist(alpha,i) for i in r], DCG_mean_random, color="red",
                         label="Random Rank Allocation")
                plt.plot([std_beta_dist (alpha,i) for i in r], DCG_mean_Asc, color="blue",
                         label="Ascending Rank Allocation")
                plt.plot([std_beta_dist (alpha,i) for i in r], DCG_mean_Desc, color="green",
                         label="Descending Rank Allocation")
                #plt.axhline(y=0.5, color='black', linestyle='-')
                plt.xlabel("Std_beta")
                plt.ylabel("DCG")
                ...
                plt.title(
                    "Beta:Alpha=" + str(alpha) + " Pos=" + str(d["pos"]) + " Rl=" + str(
                        d["Ranking_length"]))
                plt.savefig(
                    "C:/Users/ziedk/PycharmProjects/Master Thesis/Plots/Beta Distribution/DCG/New DCG Beta Vary beta alpha=" + str(
                        alpha) + " pos= " + str(d["pos"]) + " R length= " + str(d["Ranking_length"]) + ".png")
                plt.show()
    ...
    for l in RL:
        ...
        for beta in Beta:
            ...
            for pos in Pos:
                ...
                plt.plot([i/(i+beta)for i in r], DCG_mean_random, color="red",
                         label="Random Rank Allocation")
                plt.plot([i/(i+beta)for i in r], DCG_mean_Asc, color="blue",
                         label="Ascending Rank Allocation")
                plt.plot([i/(i+beta)for i in r], DCG_mean_Desc, color="green",
                         label="Descending Rank Allocation")
                #plt.axhline(y=0.5, color='black', linestyle='-')
                ...
                plt.title(
                    "Beta:Beta=" + str(beta) + " Pos=" + str(d["pos"]) + " Rl= " + str(
                        d["Ranking_length"]))
                plt.savefig(
                    "C:/Users/ziedk/PycharmProjects/Master Thesis/Plots/Beta Distribution/DCG/New DCG Beta dist Vary alpha_mean beta=" + str(
    ...
    for l in RL:
        ...
        for beta in Beta:
            ...
            for pos in Pos:
                ...
                plt.plot([std_beta_dist(i,beta)for i in r], DCG_mean_random, color="red",
                         label="Random Rank Allocation")
                plt.plot([std_beta_dist(i,beta)for i in r], DCG_mean_Asc, color="blue",
                         label="Ascending Rank Allocation")
                plt.plot([std_beta_dist(i,beta)for i in r], DCG_mean_Desc, color="green",
                         label="Descending Rank Allocation")
                #plt.axhline(y=0.5, color='black', linestyle='-')
                ...
                plt.title(
                    "Beta:Beta=" + str(beta) + " Pos=" + str(d["pos"]) + " Rl= " + str(
                        d["Ranking_length"]))
                plt.savefig(
                    "C:/Users/ziedk/PycharmProjects/Master Thesis/Plots/Beta Distribution/DCG/New DCG Beta dist Vary alpha_std beta=" + str(
                        beta) + " pos= " + str(d["pos"]) + " R length= " + str(d["Ranking_length"]) + ".png")
                plt.show()
    ...
    for l in RL:
        ...
        for prop_dist in Prop_dist:
            ...
            for mean_diff in Mean_diff:
                ...
                #print(DCG_change_mean_Asc)
                for pos in Pos:
                    d["pos"] = pos
                    print("pos= ", pos)
                    DCG_change_mean_random = Measuring_quality(Ranking_change_mean_random, "DCG", d)
                    # print("DCG_mean_random",DCG_mean_random)
                    DCG_change_mean_Asc = Measuring_quality(Ranking_change_mean_Asc, "DCG", d)
                    # print("DCG_mean_Asc", DCG_mean_Asc)
                    DCG_change_mean_Desc = Measuring_quality(Ranking_change_mean_Desc, "DCG", d)
                    # print("DCG_mean_Desc",DCG_mean_Desc)
                    #print(DCG_change_mean_random)

                    plt.plot([i*prop_dist+(1-prop_dist)*(i+mean_diff) for i in range(int(d["mean_lower_limit"]), int(d["mean_upper_limit"]))], DCG_change_mean_random, color="red",
                             label="Random Rank Allocation")
                    plt.plot([i*prop_dist+(1-prop_dist)*(i+mean_diff) for i in range(int(d["mean_lower_limit"]), int(d["mean_upper_limit"]))], DCG_change_mean_Asc, color="blue",
                             label="Ascending Rank Allocation")
                    plt.plot([i*prop_dist+(1-prop_dist)*(i+mean_diff) for i in range(int(d["mean_lower_limit"]), int(d["mean_upper_limit"]))], DCG_change_mean_Desc, color="green",
                             label="Descending Rank Allocation")
                    plt.xlabel("Mean")
                    plt.ylabel("DCG")
                    plt.legend()
                    ...
                    plt.savefig("C:/Users/ziedk/PycharmProjects/Master Thesis/Plots/Bimodal Distribution/DCG/"+"New DCG BI"+"prop_dist="+str(d["p"])+"mean_range="+str([d["mean_lower_limit"],d["mean_upper_limit"]])+"mean_diff="+ str(mean_diff) + "std1=" + str(std1)+ "std2="+ str(std2) + " pos=" + str(d["pos"]) + " RL= " + str(d["Ranking_length"])+".png")
                    plt.show()
...
change_mean_bim(1,7,RL=[100],Prop_dist=[0.5],Mean_diff=[10], Pos=[0.5]) # New
change_mean_bim(1,7,RL=[100],Prop_dist=[0.5],Mean_diff=[50], Pos=[0.5]) # New
        ...
        for prop_dist in P:
            ...
            for std_diff in std_diff:
                ...
                for pos in Pos:
                    ...
                    plt.plot([std_bim(i,std_diff,prop_dist) for i in range(int(d["std1_lower_limit"]), int(d["std1_upper_limit"]))], DCG_change_mean_random, color="red",
                             label="Random Rank Allocation")
                    plt.plot([std_bim(i,std_diff,prop_dist) for i in range(int(d["std1_lower_limit"]), int(d["std1_upper_limit"]))], DCG_change_mean_Asc, color="blue",
                             label="Ascending Rank Allocation")
                    plt.plot([std_bim(i,std_diff,prop_dist) for i in range(int(d["std1_lower_limit"]), int(d["std1_upper_limit"]))], DCG_change_mean_Desc, color="green",
                             label="Descending Rank Allocation")
                    plt.xlabel("Std")
                    plt.ylabel("DCG")
                    plt.legend()
                    plt.title("Bimod:"+"P="+str(d["p"])+" Std_diff="+ str(std_diff) + " Mean1=" + str(mean1)+ " Mean2="+ str(mean2) + " Pos=" + str(d["pos"]) + " Rl=" + str(d["Ranking_length"]))
                    plt.savefig("C:/Users/ziedk/PycharmProjects/Master Thesis/Plots/Bimodal Distribution/DCG/"+"New DCG BI"+"prop_dist="+str(d["p"])+"std_range="+str([d["std1_lower_limit"],d["std1_upper_limit"]])+"std_diff="+ str(std_diff) + "mean1=" + str(mean1)+ "mean2="+ str(mean2) + " pos=" + str(d["pos"]) + " RL= " + str(d["Ranking_length"])+".png")
                    plt.show()
